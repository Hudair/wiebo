                        ...
                        <div class="faq-content">
                            ...
                            <div class="accordion faq-loop" id="faqAccordion">
                                @foreach ($faqs as $key=> $faq)
                                    <div class="card">
                                        <div @if($key==0) class="card-header active-header"
                                             @else class="card-header" @endif>
                                            <h6 class="collapsed" data-toggle="collapse"
                                                data-target="#collapse{{$faq->id}}">
                                                {{ $faq->question }}
                                                <span class="icons">
                                             @if($key==0) <i class="far fa-minus"></i> @else <i
                                                        class="far fa-plus"></i> @endif
                                        </span>
                                            </h6>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="contact-map">
                                <iframe class="border-0"
                                    src="//www.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q={{$contact->latitude ?? '36.7783'}},%20{{$contact->longitude ?? '119.4179'}}+(My%20Business%20Name)&amp;t=&amp;z=10&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                            </div>
                        </div>
                        <div class="col-lg-6">
